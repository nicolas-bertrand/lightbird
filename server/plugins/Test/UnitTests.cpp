...
bool            UnitTests::_accounts()
{
    ...
    try
    {
        ...
        ASSERT(a2->setIdFromIdentifiantAndSalt(QCryptographicHash::hash("a3" + QCryptographicHash::hash("p1" + a2->getIdFromName("a3").toAscii(), QCryptographicHash::Sha1).toHex() + "salt", QCryptographicHash::Sha1).toHex().data(), "salt"));
        ...
        ASSERT(a1->getPassword() == QCryptographicHash::hash("p1" + a2->getIdFromName("a3").toAscii(), QCryptographicHash::Sha1).toHex());
        ASSERT(a1->setPassword(""));
        ASSERT(a1->getPassword().isEmpty());
        ASSERT(a1->setPassword("p2"));
        ASSERT(a1->getPassword() == QCryptographicHash::hash("p2" + a2->getIdFromName("a3").toAscii(), QCryptographicHash::Sha1).toHex());
        ASSERT(a1->isActive());
