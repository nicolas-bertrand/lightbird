...
namespace Streamit
{
    ...
    /// the data received exceeds the content size, plugins have to indicates
...
Q_DECLARE_INTERFACE (Streamit::IDoUnserializeContent, "fr.streamit.IDoUnserializeContent");
