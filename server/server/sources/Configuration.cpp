...
bool        Configuration::_load(const QString &configurationPath, const QString &alternativePath)
{
    ...
    if (!QFileInfo(this->file.fileName()).isFile())
    {
        ...
        if (Configurations::copy(alternative, this->file.fileName()) == false)
        {
...
bool    Configuration::unitTests()
{
    Log::debug("Running the unit tests of the configuration", "Configuration", "unitTests");

    // Build the test tree
    this->set("unitTests/node1", "node1A1");
    this->set("unitTests/node1[1]", "node1B1");
    this->set("unitTests/node2[0]", "node2A1");
    this->set("unitTests/node1[2]", "node1C1");
    this->set("unitTests/node2[1]", "node2B1");
    this->set("unitTests/node1[6]", "node1D1");
    this->set("unitTests/node1[4]", "node1E1");
    this->set("unitTests/node1[2]/node3", "node3A1");
    this->set("unitTests/node1[2]/node3[1]", "node3B1");
    this->set("unitTests/node1[2]/node3[2]", "node3C1");
    this->set("unitTests/node1[2]/node3.attr1", "node3D1");
    this->set("unitTests/node1[2]/node3.attr2", "node3E1");
    this->set("unitTests/node1[2]/node3.attr1", "node3D2");
    this->set("unitTests/node1[2]/node3[2].attr3", "node3F1");
    this->set("unitTests/node1[2]/node3[1].attr4", "node3G1");
    this->set("unitTests/node1[2].attr5", "node1F1");
    this->set("unitTests/node1[3].attr5", "node1F2");
    this->set("unitTests/node1[2]/node3", "node3A2");
    this->set("unitTests/node1[2]/node3[1]", "node3B2");
    this->set("unitTests/node1[2]/node3[2]", "node3C2");
    this->set("unitTests/node1", "node1A2");
    this->set("unitTests/node1[2]", "node1C2");
    this->set("unitTests/node1[4]", "node1E2");
    try
    {
        // Test if the tree has been correctly built
        ASSERT(this->get("unitTests/node1[1]") == "node1B1");
        ASSERT(this->get("unitTests/node2[0]") == "node2A1");
        ASSERT(this->get("unitTests/node2[1]") == "node2B1");
        ASSERT(this->get("unitTests/node1[3]") == "node1D1");
        ASSERT(this->get("unitTests/node1[2]/node3.attr2") == "node3E1");
        ASSERT(this->get("unitTests/node1[2]/node3.attr1") == "node3D2");
        ASSERT(this->get("unitTests/node1[2]/node3[2].attr3") == "node3F1");
        ASSERT(this->get("unitTests/node1[2]/node3[1].attr4") == "node3G1");
        ASSERT(this->get("unitTests/node1[2].attr5") == "node1F1");
        ASSERT(this->get("unitTests/node1[3].attr5") == "node1F2");
        ASSERT(this->get("unitTests/node1[2]/node3") == "node3A2");
        ASSERT(this->get("unitTests/node1[2]/node3[1]") == "node3B2");
        ASSERT(this->get("unitTests/node1[2]/node3[2]") == "node3C2");
        ASSERT(this->get("unitTests/node1") == "node1A2");
        ASSERT(this->get("unitTests/node1[2]") == "node1C2");
        ASSERT(this->get("unitTests/node1[4]") == "node1E2");
        ASSERT(this->get("unitTests/node1[78]") == "");
        ASSERT(this->get("unitTests/node1[-1]") == "node1A2");
        ASSERT(this->get("unitTests/node1[egshuge]") == "node1A2");
        ASSERT(this->get("unitTests/node1[]") == "node1A2");
        ASSERT(this->get("unitTests/node4") == "");
        ASSERT(this->get("unitTests/node[3].attr6") == "");

        // Test the count function
        ASSERT(this->count("unitTests") == 1);
        ASSERT(this->count("unitTests/node1") == 5);
        ASSERT(this->count("unitTests/node2") == 2);
        ASSERT(this->count("unitTests/node1[2]/node3") == 3);
        ASSERT(this->count("") == 0);
        ASSERT(this->count("gesgsho") == 0);
        ASSERT(this->count("unitTests/gsegesi") == 0);
    }
    catch (Properties properties)
    {
        Log::instance()->error("Unit test failed", properties, "Configuration", "unitTests");
        return (false);
    }
    Log::instance()->debug("Unit tests successful!", "Configuration", "unitTests");
    return (true);
}
