...
namespace Streamit
{
    ...
    /// This allows a client to use several protocols on the same port (one per request).
    ...
    public:
        ...
        /// @param error : If this parameter is set to true by the plugin, it means that the
        ...
        virtual bool    onProtocol(Streamit::IClient &client, const QByteArray &data, QString &protocol, bool &error) = 0;
    };
}

Q_DECLARE_INTERFACE (Streamit::IOnProtocol, "fr.streamit.IOnProtocol");
