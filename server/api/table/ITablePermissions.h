...
namespace LightBird
{
    ...
    public:
        ...
        virtual QString getId(const QString &id_accessor, const QString &id_object, const QString &right) const = 0;
        ...
        virtual QString getRight() const = 0;
        ...
        virtual bool    isAllowed(const QString &id_accessor, const QString &id_object, const QString &right) const = 0;
        ...
        virtual bool    getRights(const QString &id_accessor, const QString &id_object, QStringList &allowed, QStringList &denied) const = 0;
    };
}
