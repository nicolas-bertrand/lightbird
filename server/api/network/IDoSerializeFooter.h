...
namespace Streamit
{
    /// @brief This interface is called to serialize the footer of a response, ie convert
    ...
    public:
         ...
         */
        virtual void    doSerializeFooter(Streamit::IClient &client, QByteArray &data) = 0;
    };
}

Q_DECLARE_INTERFACE (Streamit::IDoSerializeFooter, "fr.streamit.IDoSerializeFooter");
