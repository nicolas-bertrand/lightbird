...
namespace Streamit
{
    ...
    class ITableCollections : virtual public Streamit::ITableObjects
    {
    public:
        ...
        /// @brief Creates a new collection from the given parameters.
        ...
        /// @return If the collection has been correctly created.
        virtual bool        add(const QString &name, const QString &id_collection = "", const QString &id_account = "") = 0;

        // Fields
        /// @brief Returns the id of the parent of the collection. It is empty
        /// If the collection is at the root.
        virtual QString     getIdCollection() = 0;
        /// @brief Modify the parent of the collection.
        ...
        /// If id_accessor and right are not empty, only the collections for which the
        ...
        virtual QStringList getCollections(const QString &id_accessor = "", const QString &right = "") = 0;
