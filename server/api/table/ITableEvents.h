...
namespace LightBird
{
    ...
    public:
        ...
        /// If empty, the event will be linked to no accessor.
        /// @param id_object : The id of the object for which the event is defined.
        /// If empty, the event will be linked to no object.
        ...
        /// @brief Modify the id of the accessor of the event.
        ...
        /// @brief Modify the id of the object of the event.
        ...
        /// @brief Modify the value of an information of the event, or create it if it doesn't exists.
        ...
        /// @param start : The date from which the search begin.
        /// @param end : The date from which the search end.
